...
<Link to="/business/bio" className={styles.container_proximo_cliente} style={{ border: 'none', marginTop: '10px', borderRadius: '5px', backgroundColor: 'rgb(255, 84, 0)', height: '40px', display: 'flex', alignItems: 'center' }}>
...
<li className={styles.container_proximo_cliente} style={{ border: 'none', marginTop: '-5px', borderRadius: '5px', backgroundColor: 'rgb(255, 84, 0)', height: '40px', display: 'flex', alignItems: 'center' }}>
